...
def test_build_http_rfc_control_status_enabled_when_two_http_controls_enabled():
    row = {
        "max_http_header_length_check": "enable",
        "illegal_http_version_check": "enabled",
        "http2_max_requests_check": "enable",
    }
...
def test_build_http_rfc_control_status_disabled_when_less_than_two_http_controls_enabled():
    row = {
